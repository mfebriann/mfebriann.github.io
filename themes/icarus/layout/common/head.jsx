  ...
  render() {
    ...
    return (
      <head>
        ...
        <meta name="google-site-verification" content="OWaabuFoPx4IRN04XRKOqZzsBfuoU_HJ4-TSgeSXFF4" />
        {meta && meta.length ? <MetaTags meta={meta} /> : null}

        <title>{getPageTitle(page, config.title, helper)}</title>

        <WebApp.Cacheable helper={helper} favicon={favicon} icons={manifest.icons} themeColor={manifest.theme_color} name={manifest.name || config.title} />
